...
exports.EventDataValidate = exports.EventSchema = void 0;
...
exports.EventSchema = Yup.object().shape({
    ...
    adress: Yup.array(Yup.object().shape({
        lat: Yup.number().required(),
        lng: Yup.number().required(),
        locality: Yup.string().required(),
    })),
    geohash: Yup.string().required(),
    assessments: Yup.array(Yup.object().shape({
...
function EventDataValidate(data) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.EventSchema.validate(data, {
                        abortEarly: false,
                    })];
                case 1:
                    _a.sent();
